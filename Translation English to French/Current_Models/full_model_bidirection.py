...
def collate_batch(batch):
    ...
    batch: List of individual sample, where each sample is a tuple "returned by __getitem__" of (src_indices, src_length, tgt_indices)
    '''
...
# model.load_state_dict(torch.load('seq2seq_model_10.pth',weights_only=True))
...
for epoch in range(10,num_epochs):
    ...
    s = f"seq2seq_model_small_space{epoch + 1}.pth"
