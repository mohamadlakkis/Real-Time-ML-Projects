...
def setting_up_model(path = 'model_after_20_epochs_training/seq2seq_model.pth'):
    '''
...
if __name__ == '__main__':
    choice = input('Enter 1 to translate a sentence, 2 to exit: ')
    while choice != '2':
        sentence = input('Enter the sentence to translate: ')
        print("Original Sentence: ", sentence)
        print("Translated Sentence: ", translate_to_french(sentence))
        choice = input('Enter 1 to translate a sentence, 2 to exit: ')