...
def setting_up_model(path = 'model_after_20_epochs_training/seq2seq_model_22.pth'):
    '''
...
def index():
    ...
    return render_template('index.html', translated_sentence=translated_sentence)
